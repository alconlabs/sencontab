  ...
  object Paginas: TOvcNotebook
    ...
    object Cuentas: TOvcTabPage
      ...
      object FiltroBuscar: TGroupBox
        ...
        object FiltroBDescripcion: TOvcDbPictureField
          ...
          PictureMask = '!'
          TabOrder = 1
          OnEnter = FiltroBCuentaEnter
          OnExit = FiltroBCuentaExit
        end
      ...
      object Rejilla: TwwDBGrid
        ...
        Selected.Strings = (
          'CUENTA'#9'8'#9'CUENTA'
          'DESCRIPCION'#9'59'#9'DESCRIPCION'
          'SUMADB'#9'12'#9'SUMA~DEBE'#9'F'
          'SUMAHB'#9'12'#9'SUMA~HABER'
          'GRUPO1'#9'6'#9'GRP1'
          'GRUPO2'#9'6'#9'GRP2')
    ...
    object Datos: TOvcTabPage
      ...
      object GroupBox1: TGroupBox
        ...
        object OvcCuenta: TOvcDbPictureField
          Left = 128
          Top = 31
          Width = 49
          Height = 21
          ...
          PictureMask = '!'
          TabOrder = 0
          OnEnter = OvcCuentaEnter
        end
        object ComboGrupo1: TwwDBLookupCombo
          Left = 129
          Top = 87
          Width = 70
          Height = 21
          ...
          DataField = 'GRUPO1'
          DataSource = DSFichero
          LookupTable = DMContaRef.QGrupos
          LookupField = 'GRUPO'
        ...
        object ComboGrupo2: TwwDBLookupCombo
          Left = 129
          Top = 116
          Width = 70
          Height = 21
        ...
        object ComboGrupo1Desc: TwwDBLookupCombo
          Left = 198
          Top = 87
          Width = 348
          Height = 21
          ...
          DataField = 'GRUPO1'
          DataSource = DSFichero
          LookupTable = DMContaRef.QGruposDesc
          LookupField = 'GRUPO'
          Options = [loColLines, loTitles]
          Style = csDropDownList
          ParentFont = False
        ...
        object ComboGrupo2Desc: TwwDBLookupCombo
          Left = 198
          Top = 116
          Width = 348
          Height = 21
