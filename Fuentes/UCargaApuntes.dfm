    ...
    object Asientos: TOvcTabPage
      ...
      object Datos: TGroupBox
        ...
        object eConcepto: TwwDBLookupCombo
          ...
          AllowClearKey = True
          ShowMatchText = True
          OnCloseUp = eConceptoCloseUp
        end
        object eDescContrapartidaCBDESCSUBCUENTA: TwwDBLookupCombo
          Left = 188
          Top = 216
          Width = 309
          Height = 21
        ...
        object eContrapartidaCBSUBCUENTA: TwwDBLookupCombo
          Left = 89
          Top = 216
          Width = 100
          Height = 21
          ...
          AllowClearKey = True
          ShowMatchText = True
          OnNotInList = eContrapartidaCBSUBCUENTANotInList
        end
    ...
    object Movimientos: TOvcTabPage
      ...
      object GridEdtMovimientos: TwwDBGrid
        ...
        PictureMasks.Strings = (
          'GASTO'#9'#'#9'T'#9'T')
        Selected.Strings = (
          'ASIENTO'#9'8'#9'ASIENTO'#9#9
          'APUNTE'#9'5'#9'APTE'#9#9
          'FECHA'#9'10'#9'FECHA'#9#9
          'SUBCUENTA'#9'10'#9'SUBCUENTA'#9#9
          'ID_CONCEPTOS'#9'4'#9'CTO'#9#9
          'DescComentario'#9'47'#9'DESCRIPCION DEL APUNTE'#9#9
          'DEBEHABER'#9'2'#9'T'#9#9
          'IMPORTE'#9'14'#9'IMPORTE'#9#9
          'CONTRAPARTIDA'#9'10'#9'CONTRAP'#9#9)
