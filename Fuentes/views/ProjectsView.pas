...
procedure TProjectsView.CrearFiltro;
begin
...
procedure TProjectsView.PrepararQuery;
begin
   QFichero.Close;
...
procedure TProjectsView.RefrescarBD;
begin
...
procedure TProjectsView.BtnAppendClick(Sender: TObject);
begin
...
procedure TProjectsView.BtnSaveClick(Sender: TObject);
var
...
procedure TProjectsView.RejillaTitleButtonClick(Sender: TObject; AFieldName: String);
begin
...
procedure TProjectsView.RejillaCalcTitleAttributes(Sender: TObject; AFieldName: String;
...
procedure TProjectsView.LimpiarFiltro(Sender: TObject);
begin
   if not (TbFiltro.state in dseditmodes) then begin
      TbFiltro.edit;
   end;
