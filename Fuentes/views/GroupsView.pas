...
procedure TGroupsView.CrearFiltro;
begin
...
procedure TGroupsView.PrepararQuery;
begin
   {$Message Warn 'La instrucción WITH es ofuscadora de código`'}
...
procedure TGroupsView.RefrescarBD;
begin
...
procedure TGroupsView.BtnNavAniadirClick(Sender: TObject);
begin
...
procedure TGroupsView.BtnNavBorrarClick(Sender: TObject);
begin
...
procedure TGroupsView.BtnNavImprimirClick(Sender: TObject);
begin
...
procedure TGroupsView.BtnEdtGuardarClick(Sender: TObject);
var
...
procedure TGroupsView.BtnEdtCancelarClick(Sender: TObject);
begin
   Perform(wm_NextDlgCtl, 0, 0);
...
procedure TGroupsView.RejillaDblClick(Sender: TObject);
begin
...
procedure TGroupsView.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TGroupsView.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   case key of
      VK_ESCAPE: begin
         key := 0;
...
procedure TGroupsView.RejillaTitleButtonClick(Sender: TObject; AFieldName: String);
begin
...
procedure TGroupsView.RejillaCalcTitleAttributes(Sender: TObject; AFieldName: String;
   AFont: TFont; ABrush: TBrush; var ATitleAlignment: TAlignment);
begin
...
procedure TGroupsView.BtnNavCerrarClick(Sender: TObject);
begin
   Close;
end;

procedure TGroupsView.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TGroupsView.fcImageBtnMinimizarClick(Sender: TObject);
begin
   windowState := wsminimized;
end;

procedure TGroupsView.fcImageBtnMouseEnter(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtnBlanco);
end;

procedure TGroupsView.fcImageBtnMouseLeave(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtn);
end;

procedure TGroupsView.LimpiarFiltro(Sender: TObject);
begin
   if not (TbFiltro.state in dseditmodes) then begin
      TbFiltro.edit;
   end;
...
procedure TGroupsView.VerTabla(Sender: TObject);
begin
   {$Message Warn 'La instrucción WITH es ofuscadora de código`'}
