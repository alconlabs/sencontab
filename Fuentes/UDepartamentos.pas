...
procedure TWDepartamentos.BtnNavBorrarClick(Sender: TObject);
begin
...
procedure TWDepartamentos.BtnNavImprimirClick(Sender: TObject);
begin
...
procedure TWDepartamentos.BtnEdtGuardarClick(Sender: TObject);
var
...
procedure TWDepartamentos.BtnEdtCancelarClick(Sender: TObject);
begin
   Perform(wm_NextDlgCtl, 0, 0);
...
procedure TWDepartamentos.RejillaTitleButtonClick(Sender: TObject; AFieldName: String);
begin
...
procedure TWDepartamentos.RejillaCalcTitleAttributes(Sender: TObject; AFieldName: String;
   AFont: TFont; ABrush: TBrush; var ATitleAlignment: TAlignment);
begin
...
procedure TWDepartamentos.BtnNavCerrarClick(Sender: TObject);
begin
   Close;
end;
...
procedure TWDepartamentos.fcImageBtnMinimizarClick(Sender: TObject);
begin
   windowState := wsminimized;
end;

procedure TWDepartamentos.fcImageBtnMouseEnter(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtnBlanco);
end;

procedure TWDepartamentos.fcImageBtnMouseLeave(Sender: TObject);
begin
