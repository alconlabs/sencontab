object WPreviewForm: TWPreviewForm
  Left = 484
  Top = 303
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsNone
  Caption = 'Visor de Informe'
  ClientHeight = 420
  ClientWidth = 587
  Color = 14275008
  ...
  object PanelVisor: TPanel
    ...
    object pnlPreviewBar: TPanel
      ...
      object Panel5: TPanel
        ...
        BevelOuter = bvNone
        TabOrder = 2
        object spbPreviewClose: TSpeedButton
          Left = 5
          Top = 4
          Width = 47
          Height = 24
          ...
          Font.Style = []
          ParentFont = False
          OnClick = spbPreviewCloseClick
        end
        object spbPreviewAsiento: TSpeedButton
          Left = 62
          Top = 4
          Width = 47
          Height = 24
          ...
          Font.Style = []
          ParentFont = False
          OnClick = spbPreviewAsientoClick
        end
        object spbPreviewBorrar: TSpeedButton
          Left = 118
          Top = 4
          Width = 47
          Height = 24
          ...
          Font.Style = []
          ParentFont = False
          OnClick = spbPreviewBorrarClick
        end
        object spbPreviewCobroPago: TSpeedButton
          Left = 175
          Top = 4
          Width = 47
          Height = 24
          ...
          Font.Style = []
          ParentFont = False
          OnClick = spbPreviewCobroPagoClick
        end
      end
    end
    object ppViewer: TppViewer
      ...
      Color = clBtnShadow
      PageColor = clWindow
      Report = FormPrincipal.InformePrincipal
      ZoomPercentage = 100
      ZoomSetting = zsPageWidth
      OnClick = ppViewerClick
      OnPageChange = ppViewerPageChange
      OnPrintStateChange = ppViewerPrintStateChange
      OnStatusChange = ppViewerStatusChange
    end
