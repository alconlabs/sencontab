...
type
  TFormMenuMain = class(TCustomView)
    ...
    MenuItemTypesOfJournal: TMenuItem;
    MenuItemPaymentMethods: TMenuItem;
    MenuItemN994: TMenuItem;
    MenuItemSalespersons: TMenuItem;
    MenuItem2997: TMenuItem;
    MenuItemConceptos: TMenuItem;
    MenuItemCountys: TMenuItem;
    ...
    MenuItemDelegations: TMenuItem;
    MenuItemDepartments: TMenuItem;
    MenuItemSections: TMenuItem;
    MenuItemProjects: TMenuItem;
    MenuItemN6: TMenuItem;
    MenuItemAnalytics: TMenuItem;
