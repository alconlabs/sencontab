...
procedure TSalespersonsView.CrearFiltro;
begin
...
procedure TSalespersonsView.PrepararQuery;
begin
   {$Message Warn 'La instrucción WITH es ofuscadora de código`'}
...
procedure TSalespersonsView.RefrescarBD;
begin
...
procedure TSalespersonsView.BtnNavAniadirClick(Sender: TObject);
begin
...
procedure TSalespersonsView.BtnNavImprimirClick(Sender: TObject);
begin
...
procedure TSalespersonsView.BtnEdtGuardarClick(Sender: TObject);
var
...
procedure TSalespersonsView.BtnEdtCancelarClick(Sender: TObject);
begin
   Perform(wm_NextDlgCtl, 0, 0);
...
procedure TSalespersonsView.RejillaDblClick(Sender: TObject);
begin
...
procedure TSalespersonsView.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TSalespersonsView.FormShow(Sender: TObject);
begin
   SetBounds(0, FormPrincipal.Panel1.Top + FormPrincipal.Panel1.Height + 1, Width, Height);
   FiltroBCodigo.SetFocus;
end;

procedure TSalespersonsView.FormCreate(Sender: TObject);
begin
...
procedure TSalespersonsView.RejillaTitleButtonClick(Sender: TObject; AFieldName: String);
begin
...
procedure TSalespersonsView.RejillaCalcTitleAttributes(Sender: TObject; AFieldName: String;
   AFont: TFont; ABrush: TBrush; var ATitleAlignment: TAlignment);
begin
...
procedure TSalespersonsView.BtnNavCerrarClick(Sender: TObject);
begin
   Close;
end;

procedure TSalespersonsView.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TSalespersonsView.fcImageBtnMinimizarClick(Sender: TObject);
begin
   windowState := wsminimized;
end;

procedure TSalespersonsView.fcImageBtnMouseEnter(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtnBlanco);
end;

procedure TSalespersonsView.fcImageBtnMouseLeave(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtn);
end;

procedure TSalespersonsView.LimpiarFiltro(Sender: TObject);
begin
   if not (TbFiltro.state in dseditmodes) then begin
      TbFiltro.edit;
   end;
...
procedure TSalespersonsView.VerTabla(Sender: TObject);
begin
   {$Message Warn 'La instrucción WITH es ofuscadora de código`'}
