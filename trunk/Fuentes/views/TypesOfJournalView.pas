...
procedure TTypesOfJournalView.CrearFiltro;
begin
...
procedure TTypesOfJournalView.PrepararQuery;
begin
   {$Message Warn 'La instrucción WITH es ofuscadora de código`'}
...
procedure TTypesOfJournalView.RefrescarBD;
begin
...
procedure TTypesOfJournalView.BtnNavAniadirClick(Sender: TObject);
begin
...
procedure TTypesOfJournalView.BtnNavBorrarClick(Sender: TObject);
begin
...
procedure TTypesOfJournalView.BtnNavImprimirClick(Sender: TObject);
begin
...
procedure TTypesOfJournalView.BtnEdtGuardarClick(Sender: TObject);
var
...
procedure TTypesOfJournalView.BtnEdtCancelarClick(Sender: TObject);
begin
   Perform(wm_NextDlgCtl, 0, 0);
...
procedure TTypesOfJournalView.RejillaDblClick(Sender: TObject);
begin
...
procedure TTypesOfJournalView.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TTypesOfJournalView.FormShow(Sender: TObject);
begin
   //SetBounds(0, FormPrincipal.Panel1.Top + FormPrincipal.Panel1.Height + 1, Width, Height);
   //FiltroBCodigo.SetFocus;
end;

procedure TTypesOfJournalView.FormCreate(Sender: TObject);
begin
...
procedure TTypesOfJournalView.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   case key of
      VK_ESCAPE: begin
         key := 0;
...
procedure TTypesOfJournalView.RejillaTitleButtonClick(Sender: TObject; AFieldName: String);
begin
...
procedure TTypesOfJournalView.RejillaCalcTitleAttributes(Sender: TObject; AFieldName: String;
   AFont: TFont; ABrush: TBrush; var ATitleAlignment: TAlignment);
begin
...
procedure TTypesOfJournalView.BtnNavCerrarClick(Sender: TObject);
begin
   Close;
end;

procedure TTypesOfJournalView.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TTypesOfJournalView.fcImageBtnMinimizarClick(Sender: TObject);
begin
   windowState := wsminimized;
end;

procedure TTypesOfJournalView.fcImageBtnMouseEnter(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtnBlanco);
end;

procedure TTypesOfJournalView.fcImageBtnMouseLeave(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtn);
end;

procedure TTypesOfJournalView.LimpiarFiltro(Sender: TObject);
begin
   if not (TbFiltro.state in dseditmodes) then begin
      TbFiltro.edit;
   end;
...
procedure TTypesOfJournalView.VerTabla(Sender: TObject);
begin
  {$Message Warn 'La instrucción WITH es ofuscadora de código`'}
