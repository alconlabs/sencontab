...
procedure TStatesView.CrearFiltro;
begin
...
procedure TStatesView.PrepararQuery;
begin
   {$Message Warn 'La instrucción WITH es ofuscadora de código`'}
...
procedure TStatesView.RefrescarBD;
begin
...
procedure TStatesView.BtnAddClick(Sender: TObject);
begin
...
procedure TStatesView.BtnDeleteClick(Sender: TObject);
begin
...
procedure TStatesView.BtnReportClick(Sender: TObject);
begin
...
procedure TStatesView.BtnSaveClick(Sender: TObject);
var
...
procedure TStatesView.BtnCancelClick(Sender: TObject);
...
procedure TStatesView.DataGridDblClick(Sender: TObject);
begin
...
procedure TStatesView.FormCreate(Sender: TObject);
begin
...
procedure TStatesView.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   case Key of
      VK_ESCAPE: begin
         key := 0;
...
procedure TStatesView.RejillaTitleButtonClick(Sender: TObject; AFieldName: String);
begin
...
procedure TStatesView.RejillaCalcTitleAttributes(Sender: TObject; AFieldName: String;
   AFont: TFont; ABrush: TBrush; var ATitleAlignment: TAlignment);
begin
...
procedure TStatesView.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TStatesView.LimpiarFiltro(Sender: TObject);
begin
   if not (TbFiltro.state in dsEditModes) then begin
      TbFiltro.edit;
   end;
...
procedure TStatesView.FormShow(Sender: TObject);
begin
   Mode := fmEdit;
   Mode := fmView;
end;
