...
uses Buttons, Classes, Controls, DB, DBClient, DBCtrls, DBTables, Dialogs, ExtCtrls, fcButton, fcImage,
     ...
     SysUtils, WinProcs, WinTypes, Wwdatsrc, Wwdbgrid, Wwdbigrd, Wwkeycb;
type
...
procedure TWSecciones.BtnNavBorrarClick(Sender: TObject);
begin
...
procedure TWSecciones.BtnNavImprimirClick(Sender: TObject);
begin
...
procedure TWSecciones.BtnEdtGuardarClick(Sender: TObject);
var
...
procedure TWSecciones.BtnEdtCancelarClick(Sender: TObject);
begin
   Perform(wm_NextDlgCtl, 0, 0);
...
procedure TWSecciones.RejillaDblClick(Sender: TObject);
begin
...
procedure TWSecciones.RejillaTitleButtonClick(Sender: TObject; AFieldName: String);
begin
...
procedure TWSecciones.RejillaCalcTitleAttributes(Sender: TObject; AFieldName: String;
   AFont: TFont; ABrush: TBrush; var ATitleAlignment: TAlignment);
begin
...
procedure TWSecciones.BtnNavCerrarClick(Sender: TObject);
begin
   Close;
end;
...
procedure TWSecciones.fcImageBtnMinimizarClick(Sender: TObject);
begin
   windowState := wsminimized;
end;

procedure TWSecciones.fcImageBtnMouseEnter(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtnBlanco);
end;

procedure TWSecciones.fcImageBtnMouseLeave(Sender: TObject);
begin
