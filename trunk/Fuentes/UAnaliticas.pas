...
procedure TWAnaliticas.BtnEdtGuardarClick(Sender: TObject);
var
...
procedure TWAnaliticas.BtnEdtCancelarClick(Sender: TObject);
begin
...
procedure TWAnaliticas.BtnNavCerrarClick(Sender: TObject);
begin
   Close;
end;
...
procedure TWAnaliticas.fcImageBtnMinimizarClick(Sender: TObject);
begin
   windowState := wsminimized;
end;

procedure TWAnaliticas.fcImageBtnMouseEnter(Sender: TObject);
begin
   (Sender as TfcImageBtn).Image.LoadFromFile(gvDirImagenes + gcBtnBlanco);
end;

procedure TWAnaliticas.fcImageBtnMouseLeave(Sender: TObject);
begin
